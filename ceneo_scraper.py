...
while next:
    ...
    if response.status_code == 200:
        ...
        for opinion in opinions:
            ...
            "contact" : opinion.select_one("div.user-post__text").get_text(),
            ...
            "helpful" : opinion.select_one("button.vote-yes").get_text(),
            "unhelpful" : opinion.select_one("button.vote-no").get_text(),
            "publishing_date" : opinion.select_one("span.user-post__published > time:nth-child(1)").get('datatime'),
            "purchase_date" : opinion.select_one("span.user-post__published > time:nth-child(2)").get("datatime") if opinion.select_one('span.user-post__published > time:nth-child(2)') else None,
            }
